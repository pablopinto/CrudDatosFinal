...
<body>
    <table class ="table table-hover">
        <tr><th>Código</th><th>Nombre</th><th>Apellido</th><th>Telefono</th><th>Direccion</th><th>Proyecto</th></tr>
            ...
            <tr><td>
                    <c:out value="${a.codigoCliente}"/></td>  
                <td><c:out value="${a.nombre}"/></td>
                <td><c:out value="${a.apellido}"/></td>  
                <td><c:out value="${a.telefono}"/></td>  
                <td><c:out value="${a.direccion}"/></td>
                <td><c:out value="${a.proyecto}"/></td>  

                <td>
                    <form method="post" action="ModificaServletN">
                        <input type="hidden" name="codigoCliente" value="${a.codigoCliente}"/>
    ...
    <form method ="post" action="jsp/Modificado.jsp">
